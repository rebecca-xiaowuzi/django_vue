...
url(r'Sql/UpdateSqlConnect', customsql.UpdateSqlConnect.as_view()),
url(r'Sql/getsqlconnectlist', customsql.getsqlconnectlist.as_view()),
url(r'Sql/getsqlconnectDetail', customsql.getsqlconnectDetail.as_view()),
    url(r'Sql/AddSql', customsql.AddSql.as_view()),
url(r'Sql/getsqllist', customsql.getsqllist.as_view()),
