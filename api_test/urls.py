...
url(r'Project/deleteProject', project.deleteProject.as_view()),
...
url(r'Environment/getEnvironmentbyprojectcode', manageenvironmental.getEnvironmentbyprojectcode.as_view()),
    ...
    url(r'Environment/deleteEnvironment', manageenvironmental.deleteEnvironment.as_view()),
url(r'Environment/deleteVariable', manageenvironmental.deleteVariable.as_view()),
...
url(r'Api/deleteApi', api.deleteApi.as_view()),
...
url(r'Sql/DeleteSqlconnect', customsql.deleteSqlConnect.as_view()),
    url(r'Sql/AddSql', customsql.AddSql.as_view()),
    url(r'Sql/DeleteSql', customsql.deleteSql.as_view()),
url(r'Sql/getsqllist', customsql.getsqllist.as_view()),
url(r'Sql/UpdateSql', customsql.UpdateSql.as_view()),
url(r'Sql/getsqlDetail', customsql.getsqlDetail.as_view()),
    ...
    url(r'TestCaseSet/DeleteTestCaseSet', testcaseset.DeleteTestCaseSet.as_view()),
...
url(r'TestCase/deleteTestcase', testcase.deleteTestcase.as_view()),
...
url(r'Result/TestCaseResult', result.TestCaseResult.as_view())
]